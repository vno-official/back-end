...
public class OpenApiAggregatorController {
    ...
    record ServiceDoc(String name, String serviceId, String docPath, String prefix) {
    }
    ...
    private final List<ServiceDoc> services = List.of(
            ...
            new ServiceDoc("org", "organization-service", "/v3/api-docs/org", "/api/org"));
    ...
    private List<Map<String, Object>> getErrorList(Map<String, Object> result) {
        return (List<Map<String, Object>>) result.computeIfAbsent("x-errors", k -> new ArrayList<>());
    }
    ...
    @SuppressWarnings("unchecked")
    private void mergePaths(Map<String, Object> target, Map<String, Object> source, String prefix) {

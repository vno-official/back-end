...
public class AuthController {
  ...
  // @Operation(summary = "Logout all sessions", description = "Revokes all
  ...
  // return ResponseEntity.ok(com.vno.common.dto.ApiResponse.success("All sessions
  // logged out successfully", null));
  // }

  // @GetMapping("/sessions")
  // @Operation(summary = "Get active sessions", description = "Returns all active
  ...
  // })
  // public
  // ResponseEntity<com.vno.common.dto.ApiResponse<List<UserSessionResponse>>>
  // getSessions(
  // @Parameter(hidden = true) Authentication authentication) {
  // UUID userId = UUID.fromString(authentication.getName());
  ...
  // @Operation(summary = "Revoke session", description = "Revokes a specific
  // session")
  // @SecurityRequirement(name = "bearerAuth")
  // @ApiResponses({
  ...
  // return ResponseEntity.ok(com.vno.common.dto.ApiResponse.success("Session
  // revoked successfully", null));
  // }
}